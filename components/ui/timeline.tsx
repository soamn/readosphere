...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full font-sans text-white" ref={containerRef}>
              ...
              {isLeft && (
                <div className="w-full flex flex-col lg:flex-row justify-between lg:space-x-40">
                  ...
                  <div className="w-full flex flex-col items-start self-end px-4 lg:px-0 ">
                    <h3 className="text-2xl lg:text-4xl tracking-widest font-extralight uppercase">
                      {item.title}
                    </h3>
                    <span className="text-lg lg:text-2xl text-neutral-400  uppercase mt-4">
                      {item.category}
                    </span>
                    <div className="relative group w-full lg:w-1/2">
                      <a
                        href={`/${item.link}`}
                        className="tracking-widest w-full flex justify-between items-center mt-10 lg:mt-20"
                      >
                        View post
                        <ArrowRight />
                      </a>
