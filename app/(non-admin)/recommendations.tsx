          ...
          <Link href={rec.link || "#"} key={rec.id} target="_blank">
            ...
            <Card className="relative overflow-hidden shadow-none border-0 group w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] ">
              ...
              <img
                ...
                width={600}
                height={600}
                className="absolute inset-0 w-full h-full object-cover transition-all duration-700 ease-in-out group-hover:scale-0 group-hover:rounded-full group-hover:w-20 group-hover:h-20 group-hover:top-1/2 group-hover:left-1/2 group-hover:translate-x-[-50%] group-hover:translate-y-[-50%]"
              />
