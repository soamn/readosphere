...
const Catalogue = () => {
  return (
    <section className="w-full relative flex flex-col-reverse lg:flex-row  mt-20 px-4 md:px-10 lg:px-40 gap-8 overflow-x-clip">
      ...
      {/* Content Overlay */}
      <div className="absolute left-40  w-full h-full flex ">
        <div className="text-black max-w-xl p-4 md:p-10 lg:p-20  rounded-md ">
          <h2 className="text-4xl md:text-6xl lg:text-8xl text-nowrap">
            Stories told, softly
          </h2>
          <p className="text-md md:text-lg lg:text-2xl mt-4 text-nowrap leading-8">
          ...
          <p className="mt-4 text-md md:text-lg lg:text-2xl text-nowrap ">
